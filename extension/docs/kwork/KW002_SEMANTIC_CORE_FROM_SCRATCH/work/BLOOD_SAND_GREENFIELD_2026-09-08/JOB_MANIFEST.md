...
Status: **STEP 03 ACQUISITION COMPLETE / RAW RECOVERY 73/79 / STEP 04 BLOCKED**
...
CURRENT_DURABLE_FEED_FORWARD = 73/79
...
The historical manifest independently records run 42 as 548 results / 16 associations / totalCount 34189, matching the current direct remote carrier checks. The historical request identity remains preserved separately.
...
Historical provider economics are preserved separately from the current recovery cost; do not overwrite historical request accounting with the eleven new recovery observations.