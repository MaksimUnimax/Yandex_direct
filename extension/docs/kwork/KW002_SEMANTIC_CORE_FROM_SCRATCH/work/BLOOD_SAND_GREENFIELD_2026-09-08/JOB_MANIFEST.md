...
Status: **STEP 03 ACQUISITION COMPLETE / RAW RECOVERY 66/79 / STEP 04 BLOCKED**
...
CURRENT_DURABLE_FEED_FORWARD = 66/79
REMAINING_RUN_ORDERS = 36..48
REMAINING_COUNT = 13
RECOVERY_PROVIDER_REQUESTS = 4
RECOVERY_PROVIDER_ESTIMATED_COST_RUB = 0.08
```
...
NEXT_ACTION = RECOVER_OR_REQUERY_RUN_ORDER_36_ZNAK_ZODIAKA
```

Historical provider economics are preserved separately from the current recovery cost; do not overwrite historical request accounting with the four new recovery observations.
