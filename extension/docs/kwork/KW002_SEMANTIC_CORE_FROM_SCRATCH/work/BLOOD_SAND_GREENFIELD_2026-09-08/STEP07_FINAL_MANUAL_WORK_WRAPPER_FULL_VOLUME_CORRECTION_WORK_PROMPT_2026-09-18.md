# KW-002 / BLOOD & SAND — STEP07 FINAL MANUAL-WORK WRAPPER FULL-VOLUME CORRECTION WORK PROMPT
...
```text
COMPETITOR_GAP_CANDIDATES.csv
= baa93fab0eb0797fe06aa6e3cac2fce2538b841e

STEP07_CANDIDATE_PROVENANCE_LEDGER.csv
= 3e73a36fa177bcd31ab716999ce1ba11386a3fde
...
If material candidate/provenance/schema/business authority changed:
```text
