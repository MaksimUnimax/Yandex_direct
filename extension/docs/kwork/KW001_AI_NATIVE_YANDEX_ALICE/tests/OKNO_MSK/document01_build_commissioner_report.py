...
def build_docx():
    ...
    forbidden = [
        'генеративный', 'нейросетевой', 'Алиса/ИИ', '`count`', 'исходных строк', 'кворк', 'kwork',
    ...
    required = [
        ...
        '2 313', '19', '168 групп поискового спроса', '75 проверок',
    ...
    assert text.index('Главный результат проверки: существующее распределение основных групп спроса по страницам в целом соответствует выдаче Алисы') < text.index('Из этих 25 тем 8 разобрали углублённо')
